            ...
            <div className="row">
                <div style={{
                    ...
                    <div>
                        ...
                        <div style={{
                            ...
                            gap: '20px',
                                ...
                                <MLittleCard title="FistExamOf2025" type="Subject"></MLittleCard>
                                <MLittleCard title="FistExamOf2025" type="Assetnote"></MLittleCard>
                    </div>
                    ...
                    <p style={{
                        ...
                        <a href={`../exam/process?parameter_id=${exam.idExam}`} className={styles["text-link"]}>
                    ...
                    {/* <div style={{
                        ...
                        <a href="../exam/result" className={styles["text-link"]}>
                            <button className={styles["button-two"]}>
                                See Result
                            </button>
                        </a>
